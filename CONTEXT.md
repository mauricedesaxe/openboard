...
**Reviewer assignment**:
The relationship permitting one reviewer to evaluate one submission.
...
**Personal resource**:
A task, form response, file, or communication belonging to one speaker.

**Submission resource**:
A task or file shared by the speakers linked to one submission.
