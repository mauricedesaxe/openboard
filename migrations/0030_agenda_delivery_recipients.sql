...
CREATE TABLE agenda_delivery_work_next (
  ...
  last_error TEXT,
  UNIQUE (publication_id, agenda_item_id, recipient_key)
);

INSERT INTO agenda_delivery_work_next (
  id,
  publication_id,
  agenda_item_id,
  action,
...
CREATE TABLE agenda_delivery_attempts_next (
  id TEXT PRIMARY KEY NOT NULL,
  work_id TEXT NOT NULL REFERENCES agenda_delivery_work_next(id) ON DELETE CASCADE,
...
INSERT INTO agenda_delivery_attempts_next
SELECT * FROM agenda_delivery_attempts;

DROP TABLE agenda_delivery_attempts;
DROP TABLE agenda_delivery_work;
ALTER TABLE agenda_delivery_work_next RENAME TO agenda_delivery_work;
ALTER TABLE agenda_delivery_attempts_next RENAME TO agenda_delivery_attempts;
